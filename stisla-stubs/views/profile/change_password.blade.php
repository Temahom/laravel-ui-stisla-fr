    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Changer votre mot de Pass</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <label>Ancien mot de passe:</label><span
                    ...
                    <div class="form-group col-sm-12">
                        <label>Confimer le mot de passe:</label><span
                                class="required confirm-pwd"></span><span class="required">*</span>
                        <div class="input-group">
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-primary" id="btnPrPasswordEditSave" data-loading-text="<span class='spinner-border spinner-border-sm'></span> Processing...">Saver</button>
